...
/**
 * <p>标题: MalnutritionCaseToXML.java</p>
 * <p>业务描述:儿童营养不良专案生成xml</p>
 * <p>公司:东华软件股份公司</p>
 * <p>版权:dhcc2014</p>
 ...
 * @version V1.0 
 */
public class MalnutritionCaseToXML {
	...
	public List<Map<String,String>>  convertCode(){
		...
		String sql = "select top 20 * from EB_TRE_YYBLZA ";
		...
		try {
			...
			while (rs.next()) {
		        ...
		        //---------------------------------------------
		        elementMap.put("CREATE_ORG_CODE","");
		        elementMap.put("FEEDING_SPECIES",rs.getString("TJFSPZ"));
		        elementMap.put("FOOD_MONTH",rs.getString("SCTJFSYF"));
		        elementMap.put("APPETITE_STATUS",getAppetite_status(rs.getString("SYZK")));
		        
		        elementMap.put("DIET",rs.getString("YSXG"));
	...
	public void bulidXML(){
		...
		for (int i = 0; i < mapList.size(); i++) {
			 ...
			 userid.setText(strMap.remove("userid"));
	           ...
	           Element trans_noChild = request.addElement("B04.01.02.05");
